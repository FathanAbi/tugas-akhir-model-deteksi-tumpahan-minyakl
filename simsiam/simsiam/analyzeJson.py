...
# Load the JSON file
with open(r'C:\Users\PC\Documents\code\TA\tugas-akhir-model-deteksi-tumpahan-minyakl\simsiam\simsiam\TESTING\HybridSN\performance\HybridSN 20250617_184623_results.json', 'r') as f:
    data = json.load(f)
